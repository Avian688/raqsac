...
#ifndef COMMON_QUEUE_RAQSACSWITCHQUEUE_H_
#define COMMON_QUEUE_RAQSACSWITCHQUEUE_H_
 ...
 */
class INET_API RaqsacSwitchQueue : public PacketQueueBase, public cListener
{
  protected:
    // configuration
    int packetCapacity;
    ...
    // state
    cPacketQueue dataQueuePriority1;
    cPacketQueue dataQueuePriority2;
    cPacketQueue dataQueuePriority3;
    cPacketQueue dataQueuePriority4;
    cPacketQueue dataQueueLowestPriority;
  ...
  public:
    ...
    void trimPacket(Packet *packet);
    int getCurrentSharedMemoryLength();
...
#endif // ifndef __INET_NdpSwitchQueue_H
